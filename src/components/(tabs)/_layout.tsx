...
import HomeScreen from "@/src/components/(tabs)/index";
import EventsScreen from '@/src/components/(tabs)/mission';
import profilrScreen from '@/src/components/(tabs)/profile';
