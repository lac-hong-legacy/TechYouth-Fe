// import { forgotPassword, forgotpasswordOTP, loginUser, newpassword, registerUser } from '@/src/redux/thunks/authThunks';
...
//             state.loading = false;
//             state.error = (action.payload as string) || action.error.message || "ForgotPassword failed"
//         })
...
//             state.error = null;
//         });
//         builder.addCase(forgotpasswordOTP.fulfilled, (state, action: PayloadAction<any>) => {
//             state.loading = false;
...
//             } else {
//                 state.user = null;
//                 state.error = "Mã OTP không đúng!";
//             }
//         });
//         builder.addCase(forgotpasswordOTP.rejected, (state, action) => {
//             state.loading = false;
//             state.error = (action.payload as string) || action.error.message || "forgotpasswordOTP failed"
//         })
...
//                 } else {
//                     state.user = null;
//                     state.error = "Đổi mật khẩu thất bại!";
//                 }
//             }
//         );
...
//                 "forgotpasswordOTPPassword failed";
//         });
//     },
// });
...
import { fetchTimeline, fetchUserCollection, heartUsers, initProfile, loginUser, registerUser, StatsUser, UserProfile } from '@/src/redux/thunks/authThunks';
import { createSlice, PayloadAction } from '@reduxjs/toolkit';
